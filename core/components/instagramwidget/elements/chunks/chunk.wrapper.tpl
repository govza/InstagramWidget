<div class="instagramwidget">
	<a href="[[+inLink]]" target="_blank" class="title">
		<img
				...
				class="icon" />
		<div class="text">We are in Instagram</div>
		<div class="clear">&nbsp;</div>
	</a>
	<table class="profile">
		<tr>
			<td rowspan="2" class="avatar">
				<a href="[[+inLink]]" target="_blank"><img src="[[+inAvatar]]"></a>
			</td>
			<td class="value">
				[[+inPosts]]
				<span>Posts</span>
		...
		<tr>
			<td colspan="3" style="border-right:none !important;">
				<a href="[[+inLink]]" class="follow" target="_blank">More...</a>
			</td>
		</tr>
	</table>
